...
export const metadata = { title: 'Начать проект' };
    ...
    <>
      <section className="pt-40 md:pt-48 pb-16">
        <div className="container-x">
          <Reveal><span className="eyebrow">Бриф · 2–3 минуты</span></Reveal>
          ...
          <Reveal delay={0.25}>
            <p className="mt-10 max-w-2xl text-lg md:text-xl text-muted leading-[1.55]">
              Короткий бриф на 5 шагов — и у нас будет контекст для старта.
            </p>
          </Reveal>
        </div>
      </section>
